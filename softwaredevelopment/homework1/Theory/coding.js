function display2_1() {
  var myanswer  = "My answer goes here: undefined, true, false. null==undefined is true because both null and undefined have a falsy value making them basically the same. null === undefined is false because === is a strict equality check in which they are considered different"// TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "My answer goes here: it will cause an error becuase the variable x is not declared. if you remove use strict it will allow x to equal 3.14, that is because use strict prevents the user from using undeclared variables" // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "The children contain only the element nodes and since div is a child of body it is a child of the child" // TODO 2.5: Fill in Answer here
