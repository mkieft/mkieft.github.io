...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = (letter.classList == "valid" && capital.classList == "valid" && number.classList == "valid" 
    				&& length.classList == "valid" && match.classList == "valid"); // TODO: Replace false with the correct condition
    if(condition) {       
